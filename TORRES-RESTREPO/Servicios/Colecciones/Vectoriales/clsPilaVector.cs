...
namespace Servicios.Colecciones.Vectoriales
{
    public class clsPilaVector<Tipo> : clsTADVectorial<Tipo>, iPila<Tipo>, iTAD<Tipo> where Tipo : IComparable<Tipo> // El : quiere decir que implementará los métodos públicos de la interfaz iPila.
    {
        ...
        public void OrdenarQuickSort(bool prmValor)
        {
            ...
            #region Método de Quick Sort Casi completo, pero con 3 errores en total
            //if (prmValor == false) //Ordenar en forma ascendente
            //{
            //    int izquierda = 0;
        ...
        #region Método no implementado para Quick Sort
        //public void Particionar(int izquierda, int derecha)
        //{
        //    Tipo Puntero = atrItems[izquierda];
        //    int i = izquierda;
        //    int j = derecha;
        ...
        //            i++;
        //        }
        //        while (atrItems[i].CompareTo(Puntero) > 0)
        //        {
        //            j--;
        //        }
        //        if (i < j)
        ...
        //    if (izquierda < j - 1)
        //    {
        //        Particionar(izquierda, j - 1);
        //    }
        //    if (j + 1 < derecha)
        //    {
        //        Particionar(j + 1, derecha);
        //    }
